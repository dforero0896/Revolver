...
handle = 'CATALPTCICz0.466G960S1005638091_wran_nopad_niter1'  # string to identify the run; used to set filenames
handle_ran = 'box_uniform_random_seed1_0-2500_nopad_niter1_r'
...
niter = 1       # number of iterations in the FFT reconstruction method, 3 is sufficient with z=0.5 f=0.754
...
tracer_file = 'tests/CATALPTCICz0.466G960S1005638091.dat'     # /path/to/file with input data
